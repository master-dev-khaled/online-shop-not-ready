                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 d-flex flex-column justify-content-between">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="exampleInputUsername1" name="username">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 d-flex flex-column justify-content-between">
                        ...
                        <input type="submit" value="signUp" class="btn text-danger bg-light" name="signupbtn">
                    </div>
                </div>
            </form>
        </div>
